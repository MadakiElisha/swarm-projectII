...
#include "swarm_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
using _Detection__ros_msg_type = swarm_interfaces__msg__Detection;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_interfaces__msg__Detection;
    is_plain =
      (
      offsetof(DataType, bbox_h) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const swarm_interfaces__msg__Detection * ros_message = static_cast<const swarm_interfaces__msg__Detection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_swarm_interfaces__msg__Detection(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  swarm_interfaces__msg__Detection * ros_message = static_cast<swarm_interfaces__msg__Detection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_swarm_interfaces__msg__Detection(cdr, ros_message);
}

static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_swarm_interfaces__msg__Detection(
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_swarm_interfaces__msg__Detection(
