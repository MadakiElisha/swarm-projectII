...
#include "swarm_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const swarm_interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  swarm_interfaces::msg::Detection & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const swarm_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swarm_interfaces::msg::Detection *>(
    untyped_ros_message);
...
get_message_type_support_handle<swarm_interfaces::msg::Detection>()
{
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, swarm_interfaces, msg, Detection)() {
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
