...
#include "swarm_interfaces/msg/detail/drone_telemetry__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_interfaces::msg::DroneTelemetry;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const swarm_interfaces::msg::DroneTelemetry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swarm_interfaces::msg::DroneTelemetry *>(
    untyped_ros_message);
...
{
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_DroneTelemetry__handle;
}
