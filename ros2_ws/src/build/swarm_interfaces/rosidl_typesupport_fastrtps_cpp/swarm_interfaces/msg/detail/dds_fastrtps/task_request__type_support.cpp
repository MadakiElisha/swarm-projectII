...
#include "swarm_interfaces/msg/detail/task_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const swarm_interfaces::msg::TaskRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  swarm_interfaces::msg::TaskRequest & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_swarm_interfaces
max_serialized_size_TaskRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = swarm_interfaces::msg::TaskRequest;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_swarm_interfaces
max_serialized_size_key_TaskRequest(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const swarm_interfaces::msg::TaskRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<swarm_interfaces::msg::TaskRequest *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TaskRequest__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const swarm_interfaces::msg::TaskRequest *>(
...
static size_t _TaskRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TaskRequest(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TaskRequest__callbacks = {
...
static rosidl_message_type_support_t _TaskRequest__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TaskRequest__callbacks,
...
{
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_TaskRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, swarm_interfaces, msg, TaskRequest)() {
  return &swarm_interfaces::msg::typesupport_fastrtps_cpp::_TaskRequest__handle;
}
