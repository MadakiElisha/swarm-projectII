...
bool swarm_interfaces__msg__task_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_interfaces.msg._task_request.TaskRequest", full_classname_dest, 46) == 0);
  }
  swarm_interfaces__msg__TaskRequest * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TaskRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_interfaces.msg._task_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskRequest");
