    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'swarm_interfaces.msg.DetectionArray')
            logger.debug(
            ...
            from swarm_interfaces.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<swarm_interfaces/Detection>',
        'count': 'uint32',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['swarm_interfaces', 'msg'], 'Detection')),  # noqa: E501
