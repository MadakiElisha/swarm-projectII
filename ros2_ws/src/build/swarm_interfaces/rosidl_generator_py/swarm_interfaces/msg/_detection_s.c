...
bool swarm_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_interfaces.msg._detection.Detection", full_classname_dest, 41) == 0);
  }
  swarm_interfaces__msg__Detection * ros_message = _ros_message;
  {  // header
  ...
  {  // bbox_x
    ...
    assert(PyFloat_Check(field));
    ros_message->bbox_x = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // bbox_y
    ...
    assert(PyFloat_Check(field));
    ros_message->bbox_y = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // bbox_w
    ...
    assert(PyFloat_Check(field));
    ros_message->bbox_w = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // bbox_h
    ...
    assert(PyFloat_Check(field));
    ros_message->bbox_h = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * swarm_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_interfaces.msg._detection");
