    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'swarm_interfaces.msg.TaskAssignment')
            logger.debug(
...
class TaskAssignment(metaclass=Metaclass_TaskAssignment):
    ...
    def __init__(self, **kwargs):
        ...
        self.assigned_to = kwargs.get('assigned_to', str())
    ...
    def __eq__(self, other):
        ...
        if self.task_id != other.task_id:
            return False
        if self.assigned_to != other.assigned_to:
            return False
    ...
    def assigned_to(self, value):
        if self._check_fields:
            assert \
                isinstance(value, str), \
                "The 'assigned_to' field must be of type 'str'"
